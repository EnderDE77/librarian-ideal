...
public abstract class SignUpView {
    public static Pane startScene(){
        ...
        btSignUp.setOnAction(e->{
            ...
            boolean isSignedIn = Warehouse.createUser(tfUser.getText(),tfPass.getText(),tfName.getText(),tfBDay.getText(),tfEmail.getText(),tfPhoneNo.getText(),a,tfConfPass.getText());
            tfEmail.clear();
            tfName.clear();
            tfBDay.clear();
            tfConfPass.clear();
            ...
            tfPass.clear();
            tfUser.clear();
            if(isSignedIn) txt.setText("User successfully signed in");
            else txt.setText("Failed sign in");
        });
